...
class MainWindow_Ui(QtCore.QObject):
    ...
    def setupUi(self, MainWindow):
        ...
        self.Window.setStyleSheet("background-color: #F0F2F5;")
        ...
        self.Menu.setMinimumHeight(56)
        self.Menu.setMaximumHeight(56)
        self.Menu.setStyleSheet("background-color: #1E1E2E; border-radius: 0px;")
...
"font-weight: bold;")
        ...
        self.active_btn.setMaximumSize(QtCore.QSize(130, 40))
        ...
        self.config_btn.setMaximumSize(QtCore.QSize(130, 40))
    ...
    def add_message(self, message, type=0):
        ...
        html = '<span style="color:#9CA3AF;">%s</span><span style="color:%s;">%s</span>' % (ts, color, message)
        self.output_textarea.append(html)
        self.output_textarea.verticalScrollBar().setValue(
            self.output_textarea.verticalScrollBar().maximum()
        )
        if not type == 0:
